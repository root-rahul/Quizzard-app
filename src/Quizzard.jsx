...
const styles = {
  ...
  logoRow: { position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 24px", background: "rgba(17,24,39,0.55)", backdropFilter: "blur(0px)" },
