...
export default function Quizzard() {
  ...
  const handleAnswer = (idx) => {
    ...
    setSelected(idx);
    const q = questions[active.id][currentIdx];
  ...
  const handleNext = () => {
    const total = questions[active.id].length;
  ...
  if (screen === "quiz" && active) {
    const allQ = questions[active.id];
              ...
              >
                ...
                <div style={styles.cardSub}>
                  {done
                    ...
                    : `${questions[cat.id].length} questions · tap to start`}
                </div>
                <div style={{ ...styles.playRow, color: cat.bg }}>Play →</div>
                {done && (
                  <div style={{
                    ...styles.doneBadge,
